...
def test_apology_template_policy_underperforms_contextual_policy():
    from support_queue_env.server.your_environment import SupportQueueEnvironment
    ...
    apology_scores = [
        score("ticket_triage", "support", "Sorry for the inconvenience, we are reviewing your case."),
        score("reply_drafting", "support", "Sorry for the inconvenience, we are reviewing your case."),
        score("escalation_resolution", "support", "Sorry for the inconvenience, we are reviewing your case."),
    ]
    contextual_scores = [
        score("ticket_triage", "support", "I can help resolve your login issue."),
        score("reply_drafting", "support", "I can help with your refund request."),
    ...
    assert sum(apology_scores) / len(apology_scores) < sum(contextual_scores) / len(contextual_scores)


def test_mixed_intent_policy_underperforms_contextual_policy():
    from support_queue_env.server.your_environment import SupportQueueEnvironment
    ...
    mixed_intent_scores = [
        score("ticket_triage", "support", "login refund escalate policy billing handoff dispute account password customer request issue dispute refund"),
        score("reply_drafting", "support", "login refund escalate policy billing handoff dispute account password customer request issue dispute refund"),
        score("escalation_resolution", "support", "login refund escalate policy billing handoff dispute account password customer request issue dispute refund"),
    ]
    contextual_scores = [
        score("ticket_triage", "support", "I can help resolve your login issue."),
        score("reply_drafting", "support", "I can help with your refund request."),
    ...
    assert sum(mixed_intent_scores) / len(mixed_intent_scores) < sum(contextual_scores) / len(contextual_scores)
